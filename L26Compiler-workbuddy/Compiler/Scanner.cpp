...
void Scanner::Init() {
	...
	keywords.set(L"bool", 7);
	keywords.set(L"set", 8);
	keywords.set(L"if", 10);
	keywords.set(L"else", 13);
	keywords.set(L"while", 14);
	keywords.set(L"write", 15);
	keywords.set(L"read", 16);
	keywords.set(L"add", 17);
	keywords.set(L"remove", 18);
	keywords.set(L"in", 25);
	keywords.set(L"union", 26);
	keywords.set(L"inter", 27);
	keywords.set(L"true", 30);
	keywords.set(L"false", 31);
	keywords.set(L"isempty", 33);
