...
SymTab   symTab;
    ...
    /* 前瞻谓词：AExpr 是否能以此 token 开头
        ...
        正确 FIRST(AExpr) = { _ident(1), _number(2), "-"(35), "(" (11) }
     */
    bool IsAExprStart() {
        int k = la->kind;
